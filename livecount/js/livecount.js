   ...
   setTimeout(function () {   
    ...
    if (this.readyState === XMLHttpRequest.DONE) {
		if (this.status === 200) {
			...
			memberscount = degar.approximate_member_count;	
			wownon = degar.guild.name;
			if (wownon.length == 0){
				wownon = serverID
			}
			ID = degar.guild.id;
			document.getElementById('pfp').src= "https://cdn.discordapp.com/icons/" + degar.guild.id + "/" + degar.guild.icon + ".png?size=1024";
